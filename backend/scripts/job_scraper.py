        ...
        with sync_playwright() as p:
            ...
            for page_num in range(1, pages + 1):
                ...
                try:
                    ...
                    page.wait_for_selector('div[data-cy="listing-card"]', timeout=20000)
                    ...
                    for listing in listings:
                        ...
                        if title_elem:
                            jobs.append({
                                ...
                                "description": "",
                                "url": f"https://www.brightermonday.co.ke{title_elem.get_attribute('href')}",
                                "source": "BrighterMonday"
                            })
                    time.sleep(2)  # Proper delay
                except Exception as e:
                    print(f"[BrighterMonday] Page {page_num} error: {str(e)}")
            browser.close()
    except Exception as e:
        print(f"[BrighterMonday] Critical error: {str(e)}")
    return jobs
